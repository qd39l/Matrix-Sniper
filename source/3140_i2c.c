 ...
 */
int I2C_WriteReg( uint8_t deviceAddr, uint8_t value )
{
    uint8_t buff[2] = {value};
...
int I2C_Write2Reg( uint8_t deviceAddr, uint8_t  regAddr, uint8_t value )
{
